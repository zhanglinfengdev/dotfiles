...
class fzf_select(Command):
    ...
    def execute(self):
        ...
        if self.quantifier:
            ...
            command='fd --type d --hidden --follow -E ".git" -E "node_modules" -E "AOSP" -E "Library" . /etc $HOME | fzf +m'
        else:
            # match files and directories
            command='fd --hidden --follow -E ".git" -E "node_modules" -E "AOSP" -E "Library" . /etc $HOME | fzf +m'
